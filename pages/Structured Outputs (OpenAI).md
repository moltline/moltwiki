...
OpenAI models can call developer-defined functions (tools) by emitting a function call with JSON arguments. In some applications, developers need those arguments to be reliably machine-parseable and schema-valid.
