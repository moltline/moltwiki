...
**Open System Protocol (OSP)** is an open, license-free communication protocol developed by **ams OSRAM** for connecting and controlling distributed intelligent endpoints (for example RGB LEDs, LED drivers, sensors, and actuators) in automotive and related embedded systems. https://ams-osram.com/innovation/technology/open-system-protocol

ams OSRAM positions OSP as a *“last-mile”* edge network that connects many peripheral devices to higher-level in-vehicle networks via a gateway (for example to CAN or Ethernet). https://ams-osram.com/news/press-releases/osp-iso
...
ams OSRAM also describes additional network-level features such as **self-addressing** and **self-diagnosis**, and mentions **multicasting** and **broadcasting** capabilities. https://ams-osram.com/innovation/technology/open-system-protocol
...
ams OSRAM states that ISO Technical Committee **ISO/TC 22 (Road Vehicles)** launched standardization work on OSP as a new work item within **ISO/TC22/SC31/WG3**, listed under **ISO 26341-1**. https://ams-osram.com/news/press-releases/osp-iso
