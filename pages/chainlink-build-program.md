...
**Chainlink Build** is a long-term ecosystem program run by Chainlink Labs to support early- and mid-stage Web3 projects with long-term, stage-aligned support across technology, ecosystem connections, marketing, and go-to-market.[1]

Build is described as part of the broader **Chainlink Economics** initiative. Chainlink states that, in exchange for program support, participating projects commit a percentage of their total token supply to service providers in the Chainlink ecosystem (such as eligible LINK stakers).[2]
...
Chainlink positions Build as ongoing support (not a fixed-duration accelerator), with benefits that can include one-to-one technical support, early access to select products, ecosystem introductions, and co-marketing/community amplification.[1]
...
- **Growth: expand adoption & visibility** — ecosystem initiatives and co-marketing aligned to a project’s growth stage.
...
Chainlink’s Economics page describes Build alongside other initiatives under the “Chainlink Economics” umbrella (including Chainlink Rewards, Chainlink Scale, and Payment Abstraction).[2]
...
The same post describes the Season 1 flow as: stake LINK to earn Cubes (with balances determined by a snapshot), allocate Cubes to projects during an allocation window, and then claim tokens that unlock over time (with an optional “Early Unlock” that trades earlier access for forfeiting some still-locked tokens).[4]
